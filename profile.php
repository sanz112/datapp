...
?>
    ...
    <title>Swift Geek Links - Profile</title>
</head>
...
<script>
        $(window).on("load", function() {
            //alert("hello");
        $("div#alert_message").fadeOut(3000);
        $("div#alert_messageErr").fadeOut(3000);
    });
    </script>
        ...
        <div style="width: 100%;" class="card-body">
            ...
            <thead>
                ...
                <?php foreach($results as $r): ?>
                    <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b>Your ID: <?php echo $r->idSwiftUsers; ?> </td>

                    </tr>
                        <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Username: </b><?php echo $r->uidSwiftUsers; ?> </td>
                </tr>
                <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Email: </b><?php echo $r->emailSwiftUsers; ?> </td>
                </tr>
                    <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Phone Number: </b><?php echo $r->phone; ?> </td>
                </tr>
                <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your Wallet Balance: </b><span>&#x20A6</span><?php echo $r->wallet; ?> </td>
                </tr>
                       <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b>Confirmation: </b><?php if($r->confirmation == "1") {
                                echo "True";
                        } else {
                          echo "False";
                        }; ?> </td>
                  ...
                  <tr>
                        <td style="font-weight: 400; font-size: 18px;"><b> Your User Type: </b><?php echo $r->userType; ?> </td>
                </tr>
                        
                        <td>
                            <div style="float: left;" class="p-2 row">
                                     
                             <a class="btn pr-3 mr-2 btn-md btn-warning" id="updatenewuser"name="updatenewuser" href="update.php?id=<?= $r->idSwiftUsers ?>"> Edit </a>
                             <a class="btn btn-md btn-danger" id="deletenewuser" name ="deletenewuser" onclick="return confirm('Are You Sure You Want to Delete this User')" href="delete.php?id=<?= $r->idSwiftUsers ?>"> Delete </a>
