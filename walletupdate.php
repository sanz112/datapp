...
if(isset($_POST['airtimesubmit']) || isset($_POST['airtimecashsubmit']) || isset($_POST['datasubmitt']) || isset($_POST['datathirdsubmit']) || isset($_POST['cablesubmit'])) {
        //$wallet = test_input($_POST[('wallet')]);
        $wallet = test_input($_POST['amount']);
