...
<main id="myDiv">
    ...
    <form class="w-100" id="paymentForm" enctype="multipart/form-data">
  ...
  <div class="w-100 input-group mb-3">
      ...
      <input type="number" id="amount" name="amount" value="1000" class="form-control" placeholder="Amount to recharge" required aria-describedby="amount">
    </div>
    <div style="width: 100%;" class="input-group mb-3">
    <div class="input-group-prepend">
    ...
    <div class="w-100 input-group mb-3">
      <div class="input-group-prepend">
        <span class="input-group-text" id="billerCode"> Biller's Card Number </span>
      </div>
      <input type="text" id="billerCode" onblur="getPosts()"  name="billerCode"  class="form-control" placeholder="Your SmartCard Number/ID" aria-describedby="billerCode">
    </div>
    <div class=" w-100 input-group mb-3">
      <div class="input-group-prepend">
        <span class="input-group-text" id="billersCode"> Biller's Name </span>
      </div>
    ...
    <div class="input-group">
      <button style="background: #f1a947;" class="btn btn-lg btn-success btn-block" name="login-submit" type="submit">SubScribe</button>
    </div>
      </div>
</div>
  ...
  <div class="w-100 input-group mb-3">
    ...
    <div class="input-group">
      <button style="background: #f1a947;" id="btn" class="btn btn-lg btn-success btn-block" name="login-submit" type="button">SubScribe</button>
    </div>
...
var optionVarsx = [
  ...
  var username = "info@swiftgeek.com.ng";
    var password = "Datageek2020";
            ...
            //            let request_id = document.querySelector("input#refvalue").value;
            //            let amount = document.querySelector("input#amount").value;
            //            let phone = document.querySelector("input#phn_number").value;
            ...
            //                },
            //                 body: JSON.stringify({request_id:request_id, amount:amount, phone:phone, serviceID:serviceID})
            //            })
  ...
  $("button#btn").on('click', function() {
   // alert("hello");
    var url =`https://sandbox.vtpass.com/api/pay/${username}/${password}`;
        //alert("hello");
     $.ajax( url, {
    method: 'POST',
    // username : "info@swiftgeek.com.ng",
            ...
            var code = optionVarsx[i].response_description;	                     
              if(code == idxy) {
               ...
               $(optionVarsx[i].content).each(function (index,sectionObj) {
                ...
                $("input#serviceID").val(sectionObj.serviceID).attr("name", sectionObj.serviceID);
