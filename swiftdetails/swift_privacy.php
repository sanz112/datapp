...
?>
    ...
    <title>Swift Geek Links - Privacy</title>
  </head>

  <body>

    <div style="position:absolute; display: flex;width: 100%; height: 100%; justify-content: center; align-items: center;">
    <h4> Kindly Contact <a style="color: coral;" href="mailto:info@swiftgeek.com.ng">Info@swiftgeek.com.ng</a> to request for their privacy policy</h4>
    </div>
